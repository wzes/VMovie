...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.movie_download, R.id.movie_collect})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.movie_download:
                Intent intent = new Intent(MovieDetailActivity.this,DownloadActivity.class);
